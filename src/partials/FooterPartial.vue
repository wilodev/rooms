<template>
  <footer class="footer mt-6">
    <section class="footer__items bg-white border-t py-6">
      <div class="container grid-container">
        <div class="footer__brand mb-3">
          <p class="text-grey-darkest text-3xl font-semibold mb-2">Rooms</p>
          <p class="text-grey-dark">Discover entire homes and private rooms perfect for any trip.</p>
        </div>
        <div class="footer__list mb-3">
          <ul class="list-reset">
            <li class="mb-2 text-lg text-grey-darkest font-semibold">Product</li>
            <li class="mb-2">
              <a class="no-underline text-grey-darker hover:text-grey-darkest" href="#">The solution</a>
            </li>
            <li class="mb-2">
              <a
            ...
            <li class="mb-2">
              <a class="no-underline text-grey-darker hover:text-grey-darkest" href="#">Press kit</a>
            </li>
          </ul>
        </div>
    ...
    <section class="footer__copyright bg-teal-dark py-4 text-white">
      <div class="container">A Vue application for the course Advanced Vue by Wilson Pérez</div>
    </section>
  </footer>
</template>
